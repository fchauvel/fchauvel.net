...
deploy:
  steps:
    ...
    - add-ssh-key:
        keyname: DEPLOY
    - mktemp:
        envvar: PATH_TO_PRIVATE_KEY
    - create-file:
        name: Generate the key file
        filename: $PATH_TO_PRIVATE_KEY
...
submodules. The deploy phase is more lengthy. I create a temporary
file that contains the provate SSH key generated by Wercker and, which
